    ...
    $.ajax({
        ...
        success: function(msg){
            ...
            for(i=0;i<msg.surakarta.lahan.length;i++){
                ...
                jmlkk[i] = msg.surakarta.lahan[i].jmlkk;
                alamat[i] = msg.surakarta.lahan[i].alamat;
                status_lokasi[i] = msg.surakarta.lahan[i].status_jmlkk;
...
$(document).ready(function(){
    $("#search").click(function(){
        ...
        var status_jmlkk    = $("#status_jmlkk").val();
        $.ajax({
            url: "caripeta.php",
            data: "kelurahan="+kelurahan+"&status_jmlkk="+status_jmlkk,
            dataType: 'json',
            cache: false,
            success: function(msg) {
