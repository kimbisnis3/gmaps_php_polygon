    ...
    $.ajax({
        ...
        success: function(msg){
            ...
            for(i=0;i<msg.surakarta.lahan.length;i++){
                ...
                pmiskin[i] = msg.surakarta.lahan[i].pmiskin;
                status_lokasi[i] = msg.surakarta.lahan[i].status_pmiskin;
               ...
               var contentString = '<b>RW '+nama[i]+'</b><br>' +
                                    ...
                                    '<br>' +
                                    'Jumlah Penduduk Miskin: '+ pmiskin[i] +
                                        ' Jiwa<br>' +
...
$(document).ready(function(){
    $("#search").click(function(){
        ...
        var status_pmiskin    = $("#status_pmiskin").val();
        $.ajax({
            url: "caripeta.php",
            data: "kelurahan="+kelurahan+"&status_pmiskin="+status_pmiskin,
            dataType: 'json',
            cache: false,
            success: function(msg) {
