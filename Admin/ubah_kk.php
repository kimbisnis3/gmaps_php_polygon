...
$id_kk = $_GET['id_kk'];
$query = "select * from tb_kk where id_kk='$id_kk'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="col-sm-10" id="konten" style="margin-top:20px;">
      <h3>Edit Data Master KK</h3>
      <form name="form1" method="post" role="form" class="form-horizontal" action="update_kk.php" id="contact_form">

<div class="form-group">
    <label for="id" class="control-label col-sm-2">ID KK:</label>
    <div class="col-sm-2">
  <input type="text" readonly="true" name="id_kk" class="form-control" id="id_kk" value="<?php echo $buff['id_kk']; ?>" >
  </div>
  </div>
<div class="form-group ">
    <label for="id_rw" class="control-label col-sm-2">ID RW:</label>
    <div class="col-sm-5">
    <select name="id_rw" id="id_rw" class="form-control">
    <option value="<?php echo $buff['id_rw']; ?>"><?php echo $buff['id_rw']; ?></option>
    <?php 
...
<div class="form-group ">
    <label for="id" class="control-label col-sm-2">Nama Kepala Keluarga:</label>
    <div class="col-sm-5">
    <input type="text" name="nama_kepalakeluarga" class="form-control" id="nama_kepalakeluarga" value="<?php echo $buff['nama_kepalakeluarga']; ?>">
  </div>
  </div>
