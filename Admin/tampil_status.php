...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="col-sm-10" id="konten" style="margin-top:20px;">
      <h3>Tabel Status Jumlah Penduduk</h3>
      ...
      $query = "select * from status limit $posisi, $batas";
      ...
      <a href="ubah_status.php?id=<?php echo $buff ['id']; ?>" class="btn btn-warning glyphicon glyphicon-pencil" role="button" data-toggle="tooltip" title="Edit" data-placement="bottom"></a>

      <a href="#" onclick="confirm_modal('hapus_status.php?id=<?php echo $buff['id']; ?>');" class="btn btn-danger glyphicon glyphicon-trash" data-toggle="tooltip" title="Hapus" data-placement="bottom"></a></div></td>
      ...
      <?php
       ...
       //hitung jumlah data
          $jml_data = mysqli_num_rows(mysqli_query($sambung,"select * from status"));
          //Jumlah halaman
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span>Tambah Data Status Jumlah Penduduk</h4>
        </div>
<?php 
include "id.php";
try
...
$query = $dbh->query('SELECT MAX(id) as kodex  FROM  status'); 
$data = $query->fetch();
$kode = $data['kodex']; 
$nourut = ($kode); 
$nourut++; ?>
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" class="form-horizontal" name="form1" action="entry_status.php" method="POST" id="contact_form">
            ...
            <div class="form-group">
              <label for="nama_status"><span class="glyphicon glyphicon-home"></span> Nama Status</label>
