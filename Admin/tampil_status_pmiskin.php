<!DOCTYPE html>
<html>
<title>Status Jumlah Penduduk Miskin</title>
...
?>
  ...
  <a href="tampil_status_pmiskin.php" class="w3-padding w3-green"><i class="glyphicon glyphicon-map-marker"></i>  Status Jumlah Penduduk Miskin</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="col-sm-10" id="konten" style="margin-top:20px;">
      <h3>Tabel Status Jumlah Penduduk Miskin</h3>
      ...
      $query = "select * from status_pmiskin limit $posisi, $batas";
      ...
      <td><?php echo $buff['nama_status']; ?></td>
      <td><?php echo $buff['warna']; ?>
      <div class="square" style="background: <?php echo $buff['warna']; ?>"></td>
      <td>
      <div class="button-toolbar">
      <a href="ubah_status_pmiskin.php?id=<?php echo $buff ['id']; ?>" class="btn btn-warning glyphicon glyphicon-pencil" role="button" data-toggle="tooltip" title="Edit" data-placement="bottom"></a>

      <a href="#" onclick="confirm_modal('hapus_status_pmiskin.php?id=<?php echo $buff['id']; ?>');" class="btn btn-danger glyphicon glyphicon-trash" data-toggle="tooltip" title="Hapus" data-placement="bottom"></a></div></td>
      ...
      <?php
       ...
       //hitung jumlah data
          $jml_data = mysqli_num_rows(mysqli_query($sambung,"select * from status_pmiskin"));
          //Jumlah halaman
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span>Tambah Data Status Jumlah Penduduk Miskin</h4>
        </div>
<?php 
include "id.php";
try
...
$query = $dbh->query('SELECT MAX(id) as kodex  FROM  status_pmiskin'); 
$data = $query->fetch();
$kode = $data['kodex']; 
$nourut = ($kode); 
$nourut++; ?>
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" class="form-horizontal" name="form1" action="entry_status_pmiskin.php" method="POST" id="contact_form">
            <div class="form-group">
              <label for="nama_kelurahan"><span class="glyphicon glyphicon-user"></span> ID</label>
              <input type="text" class="form-control" id="id" name="id" placeholder="ID" value="<?php echo $nourut; ?>">
            </div>
            <div class="form-group">
              <label for="nama_kelurahan"><span class="glyphicon glyphicon-home"></span> Nama Status</label>
              <input type="text" class="form-control" id="nama_status" name="nama_status" placeholder="Masukan Nama Status">
            </div>
      <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Warna</label>
           <div id="cp2" class="input-group colorpicker-component">
              <input type="text" class="form-control " id="warna" value="#00AABB" name="warna" placeholder="Warna">
