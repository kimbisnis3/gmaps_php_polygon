...
include "koneksi.php";
$id_rw = $_GET['id_rw'];
$query = "select * from tb_rw where id_rw='$id_rw'";
...
<div class="col-sm-5">
  <div class="col-sm-10" id="konten" style="margin-top:20px;">
      <h3>Edit Data Master RW</h3>
      <form name="form1" method="post" role="form" class="form-horizontal" action="update_rw.php" id="contact_form">

<div class="form-group">
    <label for="id" class="control-label col-sm-2">ID:</label>
    <div class="col-sm-3">
  <input type="text" readonly="true" name="id_rw" class="form-control"  id="id_rw" value="<?php echo $buff['id_rw']; ?>">
  </div>
  </div>

<div class="form-group ">
    <label for="id" class="control-label col-sm-2">Kelurahan:</label>
    <div class="col-sm-5">
    <select name="id_kelurahan" id="id_kelurahan" class="form-control">
  <option value="<?php echo $buff['id_kelurahan']; ?>"><?php echo $buff['id_kelurahan']; ?></option>
  <?php 
...
<div class="form-group ">
    <label for="id" class="control-label col-sm-2">Nomor RW</label>
    <div class="col-sm-3">
    <input type="text" name="nama_rw" class="form-control" id="nama_rw" value="<?php echo $buff['nama_rw']; ?>">
  </div>
  </div>

<div class="form-group ">
    <label for="id" class="control-label col-sm-2">Alamat:</label>
    <div class="col-sm-6 ">
...
<div class="form-group ">
    <label for="id" class="control-label col-sm-2">Polygon:</label>
    <div class="col-sm-7">
    <input type="text" name="polygon"  class="form-control" id="polygon lg" value="<?php echo $buff['polygon']; ?>">
  </div>
  </div>
...
<div class="col-sm-3">
  <iframe src="gcltool/index.html" style="width:600px; height: 650px" >
