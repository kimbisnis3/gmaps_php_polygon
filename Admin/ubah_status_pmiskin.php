...
include "koneksi.php";
$id = $_GET['id'];
$query = "select * from status_pmiskin where id='$id'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="col-sm-10" id="konten" style="margin-top:20px;">
      <h3>Edit Tabel Status Jumlah Penduduk Miskin</h3>
      <form name="form1" method="post" role="form" class="form-horizontal" action="update_status_pmiskin.php" id="contact_form">
