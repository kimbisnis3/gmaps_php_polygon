...
$query = "select * from tb_kelurahan where id_kelurahan='$id_kelurahan'";
...
?>
  ...
  <a href="status/index.php" class="w3-padding"><i class="glyphicon glyphicon-th-list"></i>  Status Jumlah Penduduk</a>
  <a href="status_jmlkk/index.php" class="w3-padding "><i class="glyphicon glyphicon-th-list"></i>  Status Jumlah KK</a>
  <a href="status_kk/index.php" class="w3-padding"><i class="glyphicon glyphicon-th-list"></i>  Status Jumlah Penduduk Miskin</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="col-sm-10" id="konten" style="margin-top:20px;">
      <h3>Edit Master Kelurahan</h3>
      <form name="form1" method="post" role="form" class="form-horizontal" action="update_kelurahan.php" id="contact_form">
<div class="form-group">

    <label for="id_kelurahan" class="control-label col-sm-2">ID Kelurahan:</label>
    <div class="col-sm-2">
  <input type="text" readonly="true" name="id_kelurahan" class="form-control" id="id_kelurahan" value="<?php echo $buff['id_kelurahan']; ?>" >
  </div>
  </div>
<div class="form-group">
    <label for="nama_kelurahan" class="control-label col-sm-2">Nama Kelurahan:</label>
    <div class="col-sm-3">
  <input type="text" name="nama_kelurahan" class="form-control" id="nama_kelurahan" value="<?php echo $buff['nama_kelurahan']; ?>" >
  </div>
  </div>

<div class="form-group ">
    <label for="lat" class="control-label col-sm-2">Latitude :</label>
    <div class="col-sm-2">
    <input type="text" name="lat" class="form-control" id="lat" value="<?php echo $buff['lat']; ?>">
  </div>
  </div>
<div class="form-group ">
    <label for="long" class="control-label col-sm-2">Longitude :</label>
    <div class="col-sm-2">
    <input type="text" name="longit" class="form-control" id="longit" value="<?php echo $buff['longit']; ?>">
  </div>
  </div>
