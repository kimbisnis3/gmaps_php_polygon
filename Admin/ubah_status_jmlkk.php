...
include "koneksi.php";
$id = $_GET['id'];
$query = "select * from status_jmlkk where id='$id'";
...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  <div class="w3-container w3-row">
    <div class="w3-col s4">
      <img src="css/img_avatar2.png" class="w3-circle w3-margin-right" style="width:46px">
    </div>
    <?php
session_start();
/**
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="col-sm-10" id="konten" style="margin-top:20px;">
      <h3>Edit Tabel Status Jumlah KK</h3>
      <form name="form1" method="post" role="form" class="form-horizontal" action="update_status_jmlkk.php" id="contact_form">
